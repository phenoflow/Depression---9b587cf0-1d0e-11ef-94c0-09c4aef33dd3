...
steps:
  ...
  depression-swings---primary:
    run: depression-swings---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  brief-depression---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-swings---primary/output
  ...
  depression-behav---primary:
    run: depression-behav---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression-remission---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-behav---primary/output
  persistent-depression---primary:
    run: persistent-depression---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  psychogenic-depression---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: persistent-depression---primary/output
  depression-personality---primary:
    run: depression-personality---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  reactive-depression---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-personality---primary/output
  depression-feeling---primary:
    run: depression-feeling---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  seasonal-depression---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-feeling---primary/output
  ...
  depression-assoc---primary:
    run: depression-assoc---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression-depressed---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-assoc---primary/output
  ...
  puerperal-depression---primary:
    run: puerperal-depression---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression-review---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: puerperal-depression---primary/output
  depression-pregnancy---primary:
    run: depression-pregnancy---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression-reaction---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-pregnancy---primary/output
  ...
  depression-delivered---primary:
    run: depression-delivered---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression-psychosis---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-delivered---primary/output
  ...
  depression-weepiness---primary:
    run: depression-weepiness---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression-cyclothymia---primary:
    run: depression-cyclothymia---primary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: depression-weepiness---primary/output
  major-depression---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-cyclothymia---primary/output
